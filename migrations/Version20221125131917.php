 ...
 */
final class Version20221125131917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE peinture (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, nom VARCHAR(255) NOT NULL, largeur NUMERIC(8, 2) DEFAULT NULL, hauteur NUMERIC(8, 2) DEFAULT NULL, en_vente TINYINT(1) NOT NULL, prix NUMERIC(12, 2) DEFAULT NULL, date_realisation DATETIME DEFAULT NULL, description LONGTEXT NOT NULL, protfolio TINYINT(1) NOT NULL, slug VARCHAR(255) NOT NULL, file VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_8FB3A9D6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
